...
public:
  ...
  AD_l =  0.6931471805599453;
  AD_a =  5.7133631526454228;
  AD_b =  3.4142135623730950;
  AD_c = -1.6734053240284925;
  AD_p =  0.9802581434685472;
  AD_A =  5.6005707569738080;
  AD_B =  3.3468106480569850;
  AD_H =  0.0026106723602095;
  AD_D =  0.0857864376269050;
	  init(); zigset(); }
